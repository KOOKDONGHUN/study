...
int main()
{
	...
	const int H = 28; // 세로
	const int W = 28; // 가로
	const int kH = 5; // 커널 세로
	const int kW = 5; // 커널 가로
	const int pH = 2; // 패딩 세로?
	const int pW = 2; // 패딩 가로?
	const int sH = 1; // 스트라이드 세로?
	const int sW = 1; // 스트라이드 가로?
	const int maxpool_kH = 2; // 맥스풀 커널 세로
	const int maxpool_kW = 2; // 맥스풀 커널 가로
	const int maxpool_H = 14; // 맥스풀 피처맵 세로?
	const int maxpool_W = 14; // 맥스풀 피처맵 가로?
	const int maxpool_pH = 0; // 맥스풀 패딩 세로
	const int maxpool_pW = 0; // 맥스풀 패딩 가로
	const int maxpool_sH = 2; // 맥스풀 스트라이드 세로
	const int maxpool_sW = 2; // 맥스풀 스트라이드 가로
	const int dense1_units = 120; // 히든 1 노드 120
	const int dense2_units = 10; // 히든 2 노드 10 // 아웃풋
