...
for size in np.arange(0.91,0.92,0.01):
    #0~1 데이터 전처리, 데이터 입력
    ...
    x_train, x_test, y_train, y_test = tts(x,y,train_size=size,random_state=33)
    ...
    print(thresholds_0[0])
    print(thresholds_1[38])
    print(thresholds_2[36])
    print(thresholds_3[12])
    ...
    selection_xgb_0 = GridSearchCV(selection_xgb_0,{},cv=6)
    selection_xgb_1 = GridSearchCV(selection_xgb_1,{},cv=6)
    selection_xgb_2 = GridSearchCV(selection_xgb_2,{},cv=6)
    selection_xgb_3 = GridSearchCV(selection_xgb_3,{},cv=6)
    ...
    submission.to_csv(f"./Data/dacon/comp1/sample_submission_{__file__[-15:-3]}_{numbering}_{size}.csv", index = True, header=['hhb','hbo2','ca','na'],index_label='id')
...
# 0.92
# mae_0 : 0.8550364643454551
# mae_1 : 0.6384554019868374
# mae_2 : 1.8416607990026472
# mae_3 : 1.2270886618644
# mae_result : 1.140560331799835
# r2_0 : 0.8386464298935346
# r2_1 : 0.3744930004341347
# r2_2 : 0.35290024089296235
# r2_3 : 0.28941748949169355
# r2_result : 0.4638642901780813


# 0.9400000000000001
# mae_0 : 0.8270503788193067
# mae_1 : 0.6200066207726797
# mae_2 : 1.8483805540720621
# mae_3 : 1.2239258455137414
# mae_result : 1.1298408497944474
# r2_0 : 0.840263883064924
# r2_1 : 0.4385617764704992
# r2_2 : 0.3757872420062628
# r2_3 : 0.2884404231498544
# r2_result : 0.48576333117288506