...
model.save_model('./model/xgb_save/cancer.modelSave.model')
print("save complete!!")

model2 = XGBClassifier()
model2.load_model("./model/xgb_save/cancer.modelSave.model")
print("load complete!!")
...
model2 = load("./model/xgb_save/cancer.joblib.dat")
print("load complete!!")
