...
print(f"x_data.shape : {x_data.shape}") # 569,30

y_data =a_data.target
print(f"y_data : {y_data}")
print(f"y_data.shape : {y_data.shape}") # 569,
...
print(f"x_data.shape : {x_data.shape}") # x_train.shape : (569,10)

x_data = x_data.reshape(x_data.shape[0],5,2)
...
print(f"x_train.shape : {x_train.shape}") # x_train.shape : (120, 2,2)
...
model = Sequential()
model.add(LSTM(50,input_shape=(5,2),activation='relu'))
