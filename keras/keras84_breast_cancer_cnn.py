...
x_data = x_data.reshape(x_data.shape[0],10,3,1)
...
model = Sequential()
model.add(Conv2D(50,(2,2),input_shape=(10,3,1),activation='relu'))
model.add(Flatten())
