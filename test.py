...
df.to_csv('./ANSWERBOT_Project/data/ChatbotData_test.csv',index=None)

data = pd.read_csv('./ANSWERBOT_Project/data/ChatbotData_test.csv')
# print(data)
...
data.to_csv('./ANSWERBOT_Project/data/ChatbotData_test.csv')