...
# 1-5 
# dust_data_time = pd.read_csv('./data/Seoul/Seoul_dust_2020-06_by_time.csv',encoding='CP949',header=3,sep=',',error_bad_lines=False)#,index_col=2)
# dust_data_time = dust_data_time.drop('지점번호',axis=1)
# dust_data_time = dust_data_time.drop('지점명',axis=1)
# print(dust_data_time)
# view_nan(dust_data_time)
# dust_data_time = dust_data_time.interpolate()
# view_nan(dust_data_time)
# dust_data_time[]
# print(dust_data_time)


# 1-6. 일별 미세먼지 데이터 로드 월별 데이터에 6월의 평균이 없음 이걸로 일단 구해서 채워보자
...
data_origin.columns = ['avg temp', 'low temp', 'high temp', 'dust']
